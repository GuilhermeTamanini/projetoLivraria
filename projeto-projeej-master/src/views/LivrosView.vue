...
export default {
  data() {
    return {
      ...
      cadastros: [
        {
          id: "64df1589-8bad-4083-9c44-618774ee3a9f",
          nome: "cadastro 1",
          categoria: "Isekai",
          autor: "douglas",
          preco: "10pila",
        ...
        {
          id: "567e5f7a-7676-4c5f-a36b-5a766927e81a",
          nome: "cadastro 2",
          categoria: "Fantasia",
          autor: "geraldo",
          preco: "10pila",
        ...
        {
          id: "cb663175-1350-4d40-a57e-ca2adb42e643",
          nome: "cadastro 3",
          categoria: "Game",
          autor: "lucas",
          preco: "10pila",
        ...
        {
          id: "54d12bf6-b2c8-4f30-9b1d-0b3ab4e3b2c7",
          nome: "cadastro 4",
          categoria: "???",
          autor: "antony",
          preco: "10pila",
...
<template>
  <div class="container">
    <div class="title">
      <h2 class="livro-titulo">Cadastre seu livro</h2>
    </div>
  </div>
